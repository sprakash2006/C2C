...
const TechClubForm = () => {
  ...
  return (
    <div className="bg-[#000000] rounded-xl shadow-md p-8 pt-15 mx-auto w-full max-w-3xl border border-[#ffffff19]">
      ...
      <form onSubmit={handleSubmit} className="space-y-6"  onKeyDown={(e) => {  if (e.key === "Enter") {  e.preventDefault(); }  }}>
        ...
        <div className="group pb-8 w-8/10">
          ...
          <div className="relative">
            <input
              ...
              required
              className="w-full px-4 py-3 bg-gray-950 border-b border-gray-900 focus:border-blue-400 focus:outline-none text-sm text-gray-100 placeholder-gray-500 transition-all"
        ...
        <div className="group pb-8 w-8/10">
          ...
          <div className="relative">
            <input
              ...
              onChange={handleChange}
              required
              className="w-full px-4 py-3 bg-gray-950 border-b border-gray-900 focus:border-none focus:outline-none text-sm text-gray-100 placeholder-gray-500 transition-all"
            />
            <div className="absolute bottom-0 left-0 w-0 h-px bg-blue-400 group-focus-within:w-full transition-all duration-300"></div>
          </div>
        </div>
        ...
        <div className="group pb-8 w-8/10">
          ...
          <div className="relative">
            <select
              ...
              onChange={handleChange}
              required
              className="w-full px-4 py-3 bg-gray-950 border-b border-gray-900 focus:border-blue-400 focus:outline-none text-sm text-gray-100 appearance-none"
            >
        ...
        <div className="group pb-8 w-8/10">
          ...
          <textarea
            ...
            required
            rows={6}
            className="w-full px-4 py-3 bg-gray-950 border-b border-gray-900 focus:border-blue-400 focus:outline-none text-sm text-gray-100 placeholder-gray-500 transition-all resize-none"
